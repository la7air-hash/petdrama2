...
export function AccountPill() {
  ...
  if (!ready) {
    return (
      <Link
        to="/create"
        className="hidden items-center rounded-full border-2 border-foreground bg-foreground px-3 py-2 text-sm font-bold text-background transition-transform hover:-translate-y-0.5 hover:bg-primary hover:text-primary-foreground min-[421px]:inline-flex sm:px-4"
      >
        {t("nav.create")}
      </Link>
    );
